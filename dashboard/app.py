...
# Curator/candidate/recommendations functions removed 2026-05-27 — those
# were hermes-era ops-layer outputs (op-discover, op-rebalance) which were
# deleted in the bare-minimum refactor. Dashboard no longer has a curator tab.
